...
var flat_1 = function (it) {
  var own = it.flat;
  return it === ArrayPrototype$9 || (it instanceof Array && own === ArrayPrototype$9.flat) ? flat : own;
};
...
function useForm(_a) {
  ...
  var formStateProxyRef = React.useRef();
  ...
  function setValue(names, valueOrShouldValidate, shouldValidate) {
    ...
    forEach$2(_context2 = isArrayValue ? names : [names]).call(_context2, function (name) {
      ...
      shouldRender = setInternalValue(isStringFieldName ? name : keys$3(name)[0], isStringFieldName ? valueOrShouldValidate : values$2(name)[0]) || isArrayValue ? true : isFieldWatched(name);
    });
  ...
  function registerFieldsRef(ref, validateOptions) {
    ...
    if (isRadioOrCheckbox ? field && isArray$4(field.options) && find$2(_context5 = filter$2(_context6 = field.options).call(_context6, Boolean)).call(_context5, function (_a) {
      var ref = _a.ref;
  ...
  var handleSubmit = React.useCallback(function (callback) {
    return function (e) {
      return __awaiter(_this, void 0, void 0, function () {
        var fieldErrors, fields, fieldValues, errors, _a, _b, field, name_1, fieldError, e_1_1;
        ...
        return __generator(this, function (_d) {
          switch (_d.label) {
            ...
            case 3:
              ...
              _a = __values(values$2(fields)), _b = _a.next();
              _d.label = 4;
  ...
  var reset = function (values, omitResetState) {
    ...
    if (isWeb) {
      try {
        for (var _b = __values(values$2(fieldsRef.current)), _c = _b.next(); !_c.done; _c = _b.next()) {
          var field = _c.value;
    ...
    forEach$2(_context7 = values$2(resetFieldArrayFunctionRef.current)).call(_context7, function (resetFieldArray) {
  ...
  React.useEffect(function () {
    return function () {
      ...
      fieldsRef.current && process.env.NODE_ENV === 'production' && forEach$2(_context8 = values$2(fieldsRef.current)).call(_context8, function (field) {
  ...
  formStateProxyRef.current = new Proxy(formState, {
  ...
  var modifyDirtyFields = function (_a) {
    ...
    if (readFormStateRef.current.dirty) {
      ...
      if (!isUndefined(index) || isPrePend) {
        ...
        forEach$2(_context3 = values$2(dirtyFieldIndexesAndValues)).call(_context3, function (values, index) {
          var e_2, _a;
...
var Controller = function (_a) {
  ...
  var isNotFieldArray = React.useMemo(function () {
    return !isNameInFieldArray(fieldArrayNamesRef.current, name);
