...
import { DeepPartial, FieldValues, FormStateProxy, FieldErrors, OnSubmit, FieldElement, ValidationOptions, FieldName, ManualFieldError, MultipleFieldErrors, Control, OmitResetState, Message, LiteralToPrimitive, IsFlatObject } from './types';
...
export declare type FormContextValues<FormValues extends FieldValues = FieldValues> = {
    ...
    setValue<T extends string, U extends unknown>(name: T, value: T extends keyof FormValues ? DeepPartial<FormValues[T]> : LiteralToPrimitive<U>, shouldValidate?: boolean): void;
